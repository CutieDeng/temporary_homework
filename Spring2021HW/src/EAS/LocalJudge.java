...
public class LocalJudge {
    ...
    public static void initDb(){
        System.out.println("Perform initDb");
        Db.InitRooms();
        Db.InitCourse();
    }
    ...
    public void test_01_Building() {
        System.out.println("Perform test 01");
        try {
    ...
    public void test_02_Classroom() {
        System.out.println("Perform test02");
    ...
    public void test_03_Course() {
        System.out.println("Perform test03");
        Teacher teacher = new Teacher("3000001" , "ZHANG3");
    ...
    public void test_04_Teacher() {
        System.out.println("Perform test04");
    ...
    public void test_05_Student() {
        System.out.println("Perform test05");
    ...
    public static void stupidTest() {
        ...
        Time.exceptions.forEach(System.err::println);
    }
